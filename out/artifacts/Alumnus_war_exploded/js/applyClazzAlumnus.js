				...
				$('.input-group').append(
					'<input id="apply_input" type="text" class="form-control" placeholder="输入班级名称....">\
	                   <span class="input-group-btn">\
	                     <button id="apply" class="btn btn-primary" type="button">申请加入班级</button>\
	                   </span>\
	                   <a href="clazz_addition.html"><button class="btn btn-primary col-md-offset-10" type="button">创建班级</button></a>');
